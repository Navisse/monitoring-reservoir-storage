function clr_pct = fcssm(dir_im,Sun_zen,Sun_azi,ptm,...
    Water,Snow,plcim,plsim,ijDim,jiUL,resolu,ZC,cldpix,sdpix,snpix)
...
%          Max_cl_height=min(Max_cl_height,10*(t_temph+400-t_obj));
        ...
        for base_h=Min_cl_height:i_step:Max_cl_height % iterate in height (m)
            ...
            h=base_h;%(10*(t_obj-temp_obj)/rate_elapse+base_h);
