...
fprintf('Cloud, cloud shadow, and snow detection for Landsat %d images without TIRS (Sentinel 2 scenario)\n',num_Lst); 
...
clr_pct = Fmask(norMTL.name,cldpix,sdpix,snpix,cldprob,num_Lst); % newest version 3.2
end